...
object MessierCatalog {
    ...
    val byNumber: Map<Int, MessierObject> = listOf(
        MessierObject(31, 10.684, 41.269, "仙女座星系", "Andromeda Galaxy", "G"),
        MessierObject(32, 10.674, 40.866, "M32", "", "G"),
        MessierObject(33, 23.462, 30.660, "三角座星系", "Triangulum Galaxy", "G"),
        MessierObject(42, 83.822, -5.391, "猎户座大星云", "Orion Nebula", "N"),
        MessierObject(43, 83.86, -5.27, "M43", "De Mairan's Nebula", "N"),
        MessierObject(44, 130.099, 19.675, "蜂巢星团", "Beehive Cluster", "OC"),
        MessierObject(45, 56.750, 24.117, "昴星团", "Pleiades", "OC"),
        MessierObject(13, 250.422, 36.461, "武仙座球状星团", "Hercules Cluster", "GC"),
        MessierObject(57, 283.396, 33.029, "环状星云", "Ring Nebula", "PN"),
        MessierObject(27, 299.902, 22.721, "哑铃星云", "Dumbbell Nebula", "PN"),
        MessierObject(8, 270.965, -24.382, "礁湖星云", "Lagoon Nebula", "N"),
        MessierObject(20, 270.635, -23.026, "三裂星云", "Trifid Nebula", "N"),
        MessierObject(17, 275.192, -16.172, "欧米伽星云", "Omega Nebula", "N"),
        MessierObject(16, 274.697, -13.785, "鹰状星云", "Eagle Nebula", "N"),
        MessierObject(51, 202.483, 47.195, "涡状星系", "Whirlpool Galaxy", "G"),
        MessierObject(104, 189.998, -11.623, "草帽星系", "Sombrero Galaxy", "G"),
        MessierObject(81, 148.888, 69.065, "波德星系", "Bode's Galaxy", "G"),
        MessierObject(82, 148.968, 69.680, "雪茄星系", "Cigar Galaxy", "G"),
        MessierObject(101, 210.802, 54.349, "风车星系", "Pinwheel Galaxy", "G"),
        MessierObject(63, 198.955, 42.029, "向日葵星系", "Sunflower Galaxy", "G"),
        MessierObject(64, 194.181, 21.683, "黑眼星系", "Black Eye Galaxy", "G"),
        MessierObject(5, 229.638, 2.081, "M5", "", "GC"),
        MessierObject(15, 322.493, 12.167, "M15", "", "GC"),
        MessierObject(11, 282.768, -6.271, "野鸭星团", "Wild Duck Cluster", "OC"),
        ...
        MessierObject(6, 269.643, -32.232, "蝴蝶星团", "Butterfly Cluster", "OC"),
        MessierObject(7, 271.079, -34.798, "托勒密星团", "Ptolemy Cluster", "OC"),
        ...
        MessierObject(97, 168.700, 55.020, "猫头鹰星云", "Owl Nebula", "PN"),
