...
- **丰富的星空标注**：
  - 88 星座官方连线（对齐 Stellarium v23.4 星座连线数据，672 条线段）与中英文名称；
...
- **专业天文工具**：
  - 相机 Pro 手动曝光（ISO / 快门调节，应对光污染与暗弱星场）与电子水平仪；
  - 视场角（FOV）自动标定；
...
│   ├── build.gradle.kts
│   └── settings.gradle.kts
├── docs/                   # 完整工程文档与 42 份验证增补报告（§0.10 ~ §0.51）
...
# 运行全量单元测试（含星表完整性、天文数学、跨引擎验证，89 项全绿）
